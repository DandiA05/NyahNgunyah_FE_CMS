...
const validationSchema = z.object({
  ...
  password: z.string().min(1, { message: "Alasan is required" }),
});
...
const SignIn: React.FC = () => {
  ...
  return (
    <div className="h-screen w-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex h-full flex-wrap items-center">
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="px-26 py-17.5 text-center">
            <p className="2xl:px-20">Login to your account to continue.</p>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mb-5">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 font-medium"
                >
                  {loading ? (
                    <>
